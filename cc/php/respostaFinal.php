...
/* 
 * Regista se o CC foi ou não aprovado após o parceiro receber a documentação
 */
...
mysqli_query($con, sprintf("UPDATE cad_cartaocredito SET respostafinalparceiro=%s, datarespostafinal=NOW(), status=%s WHERE lead=%s", $dt->opc, $status, $dt->lead));

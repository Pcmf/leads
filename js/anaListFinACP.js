 ...
 */
angular.module('appAnalist').controller('anaListFinACPController',function($scope,$http,NgTableParams,$modal){
    
function getData(){
    $http({
        url:"php/analista/getFinanciadosACP.php",
        method:"POST",
 ...
 */
angular.module('appAnalist').controller('modalInstanceViewComp', function($scope,$rootScope,$modalInstance,items,$timeout, $sce){

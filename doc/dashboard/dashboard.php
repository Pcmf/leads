...
$query = sprintf("SELECT count(*) FROM `arq_histprocess` WHERE (status=10 OR status=11) AND DATE(data)=DATE(NOW()) ");
$result = mysqli_query($con, $query);
if($result){
    $row = mysqli_fetch_array($result,MYSQLI_NUM);
...
//não atendidas
$query = "SELECT count(*) FROM arq_histprocess WHERE (status=3 OR status=6) AND DATE(data) = DATE(NOW()) ";
$result = mysqli_query($con, $query);
if($result){
    $row = mysqli_fetch_array($result,MYSQLI_NUM);
...
//não atendidas MES
$query = "SELECT count(*) FROM arq_histprocess WHERE (status=3 OR status=6) AND YEAR(data) = YEAR(NOW()) AND MONTH(data) = MONTH(NOW()) ";
$result = mysqli_query($con, $query);
if($result){
    $row = mysqli_fetch_array($result,MYSQLI_NUM);
    $resp['naoatendidasMes'] = $row[0];
} else {
    $resp['naoatendidasMes'] =0;
}
...
//anuladas MES
$query = "SELECT count(*) FROM arq_leads WHERE (status=4 OR status=5) AND YEAR(datastatus) = YEAR(NOW()) AND MONTH(datastatus) = MONTH(NOW())  ";
$result = mysqli_query($con, $query);
if($result){
    $row = mysqli_fetch_array($result,MYSQLI_NUM);
    $resp['anuladasMes'] = $row[0];
} else {
    $resp['anuladasMes'] =0;
}
...
//Pedidos de documentação MES
$query = sprintf("SELECT count(*) FROM `arq_histprocess` WHERE status=8 AND YEAR(data) = YEAR(NOW()) AND MONTH(data) = MONTH(NOW()) ");
$result = mysqli_query($con, $query);
if($result){
    $row = mysqli_fetch_array($result,MYSQLI_NUM);
    $resp['pedidodocMes'] = $row[0];
} else {
    $resp['pedidodocMes'] =0;
}
...
//Aprovados Mes
$query = sprintf("SELECT count(*) FROM `arq_histprocess` WHERE status=16 AND YEAR(data) = YEAR(NOW()) AND MONTH(data) = MONTH(NOW())  ");
$result = mysqli_query($con, $query);
if($result){
    $row = mysqli_fetch_array($result,MYSQLI_NUM);
    $resp['aprovadosMes'] = $row[0];
} else {
    $resp['aprovadosMes'] =0;
}
...
//Pedidos de documentação MES
$query = sprintf("SELECT count(*) FROM `arq_histprocess` WHERE status=17 AND YEAR(data) = YEAR(NOW()) AND MONTH(data) = MONTH(NOW())  ");
$result = mysqli_query($con, $query);
if($result){
    $row = mysqli_fetch_array($result,MYSQLI_NUM);
    $resp['financiadosMes'] = $row[0];
} else {
    $resp['financiadosMes'] =0;
}

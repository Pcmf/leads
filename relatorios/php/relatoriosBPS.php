 ...
 *  nomeorigem = [credijet, linhavalor, bpsfinance, creditovalorok, credistar,creditocapital, creditovalormais ]
 * 
 *  tipocredito = [ CC, CP]
 * 
 * 
...
$origens = ['credijet', 'linhavalor', 'bpsfinance', 'creditovalorok', 'credistar','creditocapital', 'creditovalormais' ];
...
//Obter dados
        ...
        if ($result) {
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                ...
                fwrite($handle, $row['gcid'] . ',"Gestlifes Financed Lead Personal",' . $row['dataentrada'] . ',,' . "\n");
            }
        }
...
//Obter dados
        ...
        if ($result) {
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                ...
                //inserir os dados no ficheiro
                fwrite($handle, $row['gcid'] . ',"Gestlifes Financed Lead Consolidated",' . $row['dataentrada'] . ',,' . "\n");
            }
        }

...
//            }
            //Assunto
            $assunto = "Id:" . $p->id . " - O Seu Crédito Aqui!";
            ...
            // Obter simulação
            $simulacao = '';
            $result = mysqli_query($con, sprintf("SELECT * FROM cad_simula WHERE lead=%s LIMIT 1", $p->id));
            if ($result) {
                $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
                $simulacao = "Valor: " . $p->montante  . "&euro;, Prazo: " . $p->prazopretendido . " Meses, Prestação: " . $p->valorprestacao . "&euro; / mês";
            }
...
//            }
            ...
            $senha = '';
            if ($pass) {
                $senha ="(senha: &nbsp;<strong>".$pass."</strong> &nbsp;)";
            }
...
//                    . "<p>Ao usar o Portal do Cliente para anexar a documentação estará a dar mais rapidez ao seu processo!";
        ...
        $msg = "<p>Olá ".$p->nome."!</p>"
                ...
                . "<a href='https://gestlifes.com/GestLifesAC'>Área de Cliente</a>".$senha."</p>"
                . "<p> ".$lista." </p>"
